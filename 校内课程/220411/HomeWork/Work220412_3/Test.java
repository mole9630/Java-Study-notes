...
@ Test.java - This is the java homework for April 12th
...
public class Test {
    public static void main(String[] args) {
        Square r = new Square(2);
        System.out.println("正方形周长为:" + r.perimeter());
        System.out.println("正方形面积为:" + r.area());

        Circle c = new Circle(3);
        System.out.println("圆形周长为:" + c.perimeter());
